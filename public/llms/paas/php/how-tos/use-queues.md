...
برای ‌به‌کار‌گیری صف‌ها با استفاده از Supervisor، کافیست تا در مسیر اصلی پروژه، یک فایل به نام `supervisor.conf` ایجاد کنید. اکنون شما می‌توانید تنظیمات صف‌های مختلف را در این فایل قرار بدهید. قطعه کد زیر، یک نمونه config ساده برای تعریف یک صف است که:
...
برای مشاهده وضعیت صف‌های تعریف شده در supervisor، کافیست تا در [https://docs.liara.ir/paas/details/console-shell](https://docs.liara.ir/paas/details/console-shell) دستور زیر را وارد کنید:
