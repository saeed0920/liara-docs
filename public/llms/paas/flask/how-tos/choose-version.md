Original link: https://docs.liara.ir/paas/flask/how-tos/choose-version/

# انتخاب نسخه Python

در حال حاضر در پلتفرم Flask لیارا، نسخه‌های زیر از  Python ارائه می‌شوند: 
...
![how to choose version in liara console](https://media.liara.ir/docs/change-python-version-in-flask-using-console.png)
