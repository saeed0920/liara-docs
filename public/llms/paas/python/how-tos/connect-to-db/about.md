Original link: https://docs.liara.ir/paas/python/how-tos/connect-to-db/about/
...
در حال حاضر، شما می‌توانید در برنامه‌های Python خود در لیارا، به دیتابیس‌های زیر، متصل شوید:
