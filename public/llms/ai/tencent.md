Original link: https://docs.liara.ir/ai/tencent/

# شروع به کار با هوش مصنوعی Tencent

[Tencent](https://www.tencent.com/) یک شرکت فناوری چندملیتی چینی و یکی از بزرگ‌ترین بازیگران اکوسیستم دیجیتال جهان است که فعالیت‌های آن از پیام‌رسانی و شبکه‌های اجتماعی مانند WeChat تا بازی، خدمات ابری و هوش مصنوعی را دربرمی‌گیرد و در حوزه AI، خانواده مدل‌های Hunyuan (混元) را توسعه می‌دهد.

در حال حاضر، لیارا، مدل‌های زیر از Tencent را در API خود پشتیبانی می‌کند:

- مدل `{item}`
  

پس از [ایجاد سرویس هوش مصنوعی](https://docs.liara.ir/ai/quick-start) و دریافت `baseUrl` و [ساخت کلید](https://docs.liara.ir/ai/details/keys/#create)، می‌توانید از مدل‌های Tencent استفاده کنید.
