...
<Layout>
<Head>
<title>مستندات شروع به کار با هوش مصنوعی Tencent - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات شروع به کار با هوش مصنوعی Tencent در لیارا"  />
</Head>
# شروع به کار با هوش مصنوعی Tencent
<hr className="mb-2" />

<a href="https://www.tencent.com/" target='_blank' className="text-[#2196f3]">Tencent</a> یک شرکت فناوری چندملیتی چینی و یکی از بزرگ‌ترین بازیگران اکوسیستم دیجیتال جهان است که فعالیت‌های آن از پیام‌رسانی و شبکه‌های اجتماعی مانند WeChat تا بازی، خدمات ابری و هوش مصنوعی را دربرمی‌گیرد و در حوزه AI، خانواده مدل‌های Hunyuan (混元) را توسعه می‌دهد.
...
پس از <a href="/ai/quick-start" className="text-[#2196f3] " >ایجاد سرویس هوش مصنوعی</a> و دریافت <Important>baseUrl</Important> و <a href="/ai/details/keys/#create" className="text-[#2196f3]" >ساخت کلید</a>، می‌توانید از مدل‌های Tencent استفاده کنید.
