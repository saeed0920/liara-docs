...
func main() {
	...
	fmt.Println("Model Response:", chatCompletion.Choices[0].Message.Content)
        ...
        <div className="h-4" />
        <p>
        در قطعه کد‌های فوق، به‌جای <Important>&lt;baseUrl&gt;</Important>، آدرس سرویس هوش مصنوعی خود را قرار دهید و به‌جای <Important>&lt;LIARA_API_KEY&gt;</Important>، <a href="/ai/details/keys" className="text-[#2196f3]">کلید API خود</a> را وارد کنید. همچنین، به‌جای <Important>&lt;model_name&gt;</Important>، نام یکی از مدل‌های خود را قرار دهید.
        </p>
    </>,
...
<Section id="text-prompt-with-file-input-and-pdf-input" title="۴. پرامپت متنی به همراه ورودی فایل یا ورودی PDF" headingTag="h3" />
<div className="h-2" />
...
console.log(result.text)`}
    ...
    <Section id="send-file-using-url" title="ارسال فایل با URL" headingTag="h4" />
...
/> 
    ...
    <Section id="send-file-using-base64" title="ارسال فایل با کدگذاری Base64" headingTag="h4" />
...
console.log(data);`,
    ...
    <Section id="skip-parsing-costs" title="پریدن از هزینه‌های parsing" headingTag="h4" />
