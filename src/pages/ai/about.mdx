...
<div className="grid md:grid-cols-3 gap-4">
    ...
    { alt: 'https://media.liara.ir/logos/ai/z-ai-white.svg', platform: 'Z.ai/GLM', link: "./z-ai" },
    { alt: 'https://media.liara.ir/logos/ai/minimax-white.png', platform: 'MiniMax', link: "./minimax" },
    { alt: 'https://media.liara.ir/logos/ai/xiaomi-logo.svg', platform: 'Xiaomi/MiMO', link: "./xiaomi" },
    { alt: 'https://media.liara.ir/logos/ai/aionlabs-logo.svg', platform: 'AION Labs', link: "./aionlabs" },
    { alt: 'https://media.liara.ir/logos/ai/huggingface-logo.svg', platform: 'Hugging Face', link: "./hugging-face" },
    { alt: 'https://media.liara.ir/logos/ai/tencent.svg', platform: 'Tencent', link: "./tencent" },
    ].map(item =>
              <Link href={item.link}>
                <Card className="flex cursor-pointer w-full items-center justify-between">
                  <div className="flex items-center gap-3">
