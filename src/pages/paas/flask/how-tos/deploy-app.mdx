...
<meta property="og:description" content="مستندات مربوط به نحوه استقرار برنامه‌های Flask در لیارا"  />
</Head>
...
`}
        ...
        {/* <div className="h-4" />
        <img src="https://media.liara.ir/docs/deploy-flask-app-using-console.gif" alt="build app on liara" />
        <div className="h-4" /> */}
        <p>
  ...
  "flask": {
    ...
    "flask": {
      "timezone": "America/Los_Angeles"
        ...
        <Section id="liara-json-main-module" title="تعیین ماژول اصلی برنامه" />
        <p>
