...
`}
        ...
        {/* <div className="h-4" />
        <img src="https://media.liara.ir/docs/deploy-go-app-using-console.gif" alt="build app on liara" />
        <div className="h-4" /> */}
        <p>
...
{/* 
  ...
  "go": {
    "mirror": false
        ...
        <Section id="liara-json-mainFile" title="تعیین فایل اصلی" />
        <p>
            ...
            که نام فایل اصلی برنامه‌تان چیز دیگری است؛ باید نام آن را در فیلدی به نام <Important>mainFile</Important> در فایل <Important>liara.json</Important> <b>به همراه پسوند <Important>go.</Important></b>، مانند شکل زیر، وارد کنید:         
        </p>
        <div className="h-4" />
        <div dir='ltr'>
        <Highlight className="json">
...
`}
        ...
        <p>
            لیارا به صورت خودکار در مسیر اصلی پروژه، فایل با نام <Important>main.go</Important> را پیدا می‌کند 
            و پس از build پروژه، با اجرای دستور <Important>go run</Important>، فایل اصلی را اجرا می‌کند. در صورتی 
            که نام فایل اصلی برنامه‌تان چیز دیگری است؛ می‌توانید در مسیر اصلی پروژه، یک فایل به نام <Important>liara.json</Important> ایجاد کنید و نام فایل اصلی خود را در فیلدی به نام <Important>mainFile</Important> در فایل <Important>liara.json</Important> <b>به همراه پسوند <Important>go.</Important></b>، مانند شکل زیر، وارد کنید:         
        </p>
        <div className="h-4" />
        <div dir='ltr'>
            <Highlight className="json">
