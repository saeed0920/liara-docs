...
<meta property="og:description" content="مستندات مربوط به نحوه استقرار برنامه‌های PHP در لیارا"  />
</Head>
...
<hr className="mb-2" />
    ...
    <>
        ...
        {/* <div className="h-4" />
        <img src="https://media.liara.ir/docs/deploy-php-app-using-console.gif" alt="build app on liara" />
        <div className="h-4" /> */}
        <p>
    ...
    "php": {
      "version": "8.3"
        ...
        <div className='h-4' />
        <Alert variant='success'>همچنین بخوانید:  <a className="text-[#2196f3] " href="../choose-version">نسخه‌های قابل ارائه php در لیارا</a></Alert>
    ...
    <>
        ...
        <p>
            پس از <a className='text-[#2196f3] ' href="../create-app">ساخت برنامه</a>، باید در مسیر اصلی پروژه، یک فایل به نام <Important>gitignore.</Important> ایجاد کنید و درون آن، اسامی تمامی فایل‌ها یا پوشه‌هایی که قصد ندارید در لیارا آپلود شوند را، وارد کنید؛ به عنوان مثال، نیازی به آپلود دایرکتوری‌های bin و vendor به همراه محتوای آن‌ها نیست؛ چرا که لیارا در حین استقرار برنامه، آن‌ها را برای شما می‌سازد؛ پس بایستی اسامی این دایرکتوری‌ها در فایل فوق، نوشته شود؛ قطعه کد قرار گرفته در لینک زیر، یک <Important>gitignore.</Important> عالی
            برای برنامه‌های PHP است که می‌توانید از آن، استفاده کنید:
        </p>
        <div className="h-2" />
        <Link href="https://github.com/liara-cloud/gitignore-templates/blob/master/php/.gitignore" target="_blank">
    ...
    "team-id": "your-team-id"
        ...
        <Alert variant='error'>
          <p>
            در فایل <Important>liara.json</Important>، برای جلوگیری از خطا خوردن فرایند استقرار، از فیلدهای <Important>app</Important> و <Important>platform</Important> استفاده نکنید؛ چرا که لیارا، آن‌ها را به صورت خودکار، تشخیص خواهد داد.
          </p>  
        </Alert>
