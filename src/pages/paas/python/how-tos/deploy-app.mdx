...
<meta property="og:description" content="مستندات نحوه استقرار برنامه‌های Python در لیارا"  />
</Head>

# استقرار برنامه Python در لیارا
<hr className="mb-2" />
    ...
    content={[
        ...
        <p>
            همچنین،
            اگر از کتابخانه یا پکیج خاصی در پروژه خود، استفاده می‌کنید که به صورت built-in یا پیش‌فرض در نسخه پایتون مدنظرتان وجود ندارد، 
            پروژه شما باید شامل فایل <Important>requirements.txt</Important> باشد؛ لیارا، در حین فرایند استقرار، به صورت خودکار این فایل را پیدا می‌کند و با اجرای دستور <Important>pip install -r</Important> تمامی ماژول‌های تعریف شده در این فایل را، برای‌تان نصب می‌کند.
            قطعه کد زیر، می‌تواند یک نمونه از فایل <Important>requirements.txt</Important> برای برنامه‌های Python باشد:
        </p>
        <div className="h-4" />
        <div dir='ltr'>
...
{/* 
                <Section id="liara-json-run-command" title="تعیین دستور اجرای برنامه" />
        <p>
            در صورتی که قصد دارید دستورات مدنظرتان، پس از استقرار برنامه، اجرا شوند؛ باید در مسیر اصلی پروژه، یک فایل به نام <Important>liara.json</Important> ایجاد کنید و درون آن، در آرایه‌ای به نام <Important>args</Important> دستورات خود را مشابه قطعه کد زیر، مشخص کنید: 
        </p>
                <div className="h-4" />
        <div dir='ltr'>
    ...
    "args": [ "python3 app.py" ]
        ...
        {/* <div className="h-4" />
        <img src="https://media.liara.ir/docs/deploy-Python-app-using-console.gif" alt="build app on liara" />
        <div className="h-4" /> */}
        <p>
        ...
        <div className="h-4" />
        <p>
            دستور اجرای برنامه در روش Liara Console، <Important>python3 main.py</Important> است و امکان تغییر آن در حال حاضر وجود ندارد.
        </p>
...
`}
    ...
    "port": 8000
        ...
        <div className='h-4' />
        <p>
            در قطعه کد فوق، در فیلد <Important>app</Important> باید شناسه برنامه خود را به جای <Important>my-python-app</Important> وارد کنید.
            در فیلد <Important>platform</Important> باید نوع پلتفرم خود را که python است، مشخص کنید. 
  ...
  "python": {
    "mirror": false
        ...
        <p>
            برای تعیین نسخه Python برنامه خود نیز، کافیست تا در فایل <Important>liara.json</Important> فیلد <Important>version</Important> را قرار دهید:
        </p>
        <div className="h-4" />
        <div dir='ltr'>
            <Highlight className="json">
  ...
  "python": {
    ...
    "python": {
      "timezone": "America/Los_Angeles"
        ...
        <Section id="liara-json-run-command-2" title="تعیین دستور اجرای برنامه" />
        <p>
    ...
    <>  
       <p>
        ...
        <p>
            ...
            اگر از کتابخانه یا پکیج خاصی در پروژه خود، استفاده می‌کنید که به صورت built-in یا پیش‌فرض در نسخه پایتون مدنظرتان وجود ندارد، 
            پروژه شما باید شامل فایل <Important>requirements.txt</Important> باشد؛ لیارا، در حین فرایند استقرار، به صورت خودکار این فایل را پیدا می‌کند و با اجرای دستور <Important>pip install -r</Important> تمامی ماژول‌های تعریف شده در این فایل را، برای‌تان نصب می‌کند.
            قطعه کد زیر، یک نمونه از فایل <Important>requirements.txt</Important> برای برنامه‌های Python است:
        </p>
        <div className="h-4" />
        <div dir='ltr'>
            <Highlight className="txt">
...
`}
  ...
  "python": {
    "version": "3.12"
        ...
        <div className='h-4' />
        <Alert variant='success'>همچنین بخوانید:  <a className="text-[#2196f3] " href="../choose-version">نسخه‌های قابل ارائه Python در لیارا</a></Alert>
        <Section id="liara-json-timezone-2" title="تعیین منطقه زمانی" />
        <p>
            به صورت پیش‌فرض، منطقه‌ی زمانی برنامه‌تان بر روی Asia/Tehran تنظیم شده است؛ برای تغییر مقدار پیش‌فرض، می‌توانید از پارامتر <Important>timezone</Important> در فایل <Important>liara.json</Important> استفاده کنید؛ به عنوان مثال:
        </p>
        <div className="h-4" />
    ...
    "python": {
      "timezone": "America/Los_Angeles"
        ...
        <Section id="liara-json-run-command-3" title="تعیین دستور اجرای برنامه" />
        <p>
            در صورتی که قصد دارید دستورات مدنظرتان، پس از استقرار برنامه، اجرا شوند؛ می‌توانید در فایل <Important>liara.json</Important> در آرایه‌ای به نام <Important>args</Important> آن‌ها را مشابه قطعه کد زیر، مشخص کنید: 
        </p>
                <div className="h-4" />
